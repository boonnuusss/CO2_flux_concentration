clear;clc
data=hnc_getall(file_path+"co23D_Emon_GFDL-ESM4_esm-hist_r1i1p1f1_gr1_185001-194912.nc");
...
clear;clc
data=hnc_getall(file_path+"co23D_Emon_GFDL-ESM4_esm-hist_r1i1p1f1_gr1_195001-201412.nc");
CO2_3D = squeeze(data.co23D.data(:,end,:,:));
