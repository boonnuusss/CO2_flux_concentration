clear;clc
data=hnc_getall(file_path+"co23D_Emon_MPI-ESM1-2-LR_esm-hist_r1i1p1f1_gn_185001-186912.nc");
...
clear;clc
data=hnc_getall(file_path+"co23D_Emon_MPI-ESM1-2-LR_esm-hist_r1i1p1f1_gn_189001-190912.nc");
CO2_3D = squeeze(data.co23D.data(:,1,:,:));
time = data.time.data-data.time.data(1);
lat = data.lat.data;
...
clear;clc
data=hnc_getall(file_path+"co23D_Emon_MPI-ESM1-2-LR_esm-hist_r1i1p1f1_gn_195001-196912.nc");
CO2_3D = squeeze(data.co23D.data(:,1,:,:));
time = data.time.data-data.time.data(1);
lat = data.lat.data;
...
clear;clc
data=hnc_getall(file_path+"co23D_Emon_MPI-ESM1-2-LR_esm-hist_r1i1p1f1_gn_199001-200912.nc");
CO2_3D = squeeze(data.co23D.data(:,1,:,:));
time = data.time.data-data.time.data(1);
lat = data.lat.data;
