clear;clc
data=hnc_getall(file_path+"co23D_Emon_UKESM1-0-LL_esm-hist_r1i1p1f2_gn_185001-189912.nc");
...
clear;clc
data=hnc_getall(file_path+"co23D_Emon_UKESM1-0-LL_esm-hist_r1i1p1f2_gn_190001-194912.nc");
CO2_3D = squeeze(data.co23D.data(:,1,:,:));
lat = data.lat.data;
...
CO2_3D_year = squeeze(sum(CO2_3D_year,1));
CO2_3D_year_lon = sum(CO2_3D_year,2);
CO2_3D_year_lon = CO2_3D_year_lon*(29/44)*1.403*(1e3)/12;
...
clear;clc
data=hnc_getall(file_path+"co23D_Emon_UKESM1-0-LL_esm-hist_r1i1p1f2_gn_195001-199912.nc");
CO2_3D = squeeze(data.co23D.data(:,1,:,:));
time = data.time.data-data.time.data(1);
lat = data.lat.data;
...
clear;clc
data=hnc_getall(file_path+"co23D_Emon_UKESM1-0-LL_esm-hist_r1i1p1f2_gn_200001-201412.nc");
CO2_3D = squeeze(data.co23D.data(:,1,:,:));
time = data.time.data-data.time.data(1);
lat = data.lat.data;
