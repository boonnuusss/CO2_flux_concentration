...
function [time_land,lat_land,lon_land,CO2_land,model] = select_parameter(filepath,filename)
    ...
    if filename== "netAtmosLandCO2Flux_Emon_MPI-ESM1-2-LR_esm-hist_r1i1p1f1_gn_195001-196912.nc"...
   ...
   if filename== "netAtmosLandCO2Flux_Emon_MPI-ESM1-2-LR_esm-hist_r1i1p1f1_gn_195001-196912.nc"...
            ...
            is_1956=(2192<time_land)&(time_land<=2557);
    else
        is_1956=(38352<time_land)&(time_land<38717);
   end
