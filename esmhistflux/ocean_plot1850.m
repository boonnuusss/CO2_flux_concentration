...
"fgco2_Omon_GFDL-ESM4_esm-hist_r1i1p1f1_gr_185001-186912.nc";
"fgco2_Omon_MPI-ESM1-2-LR_esm-hist_r1i1p1f1_gn_185001-186912.nc";
...
function [time_ocean,lat_ocean,lon_ocean,CO2_ocean,model] = select_parameter(filepath,filename)
    ...
    elseif filename=="fgco2_Omon_GFDL-ESM4_esm-hist_r1i1p1f1_gr_185001-186912.nc"
...
function [lat_ocean,CO2_flux_ocean_year_LON,model,CO2_flux_ocean_year_areas]=plot_CO2_flux_ocean_year(filepath,ocean_filename, ocean_areacello_filename)
    ...
    if ocean_filename=="fgco2_Omon_MPI-ESM1-2-LR_esm-hist_r1i1p1f1_gn_185001-186912.nc"
