...
land_filename = [...
"netAtmosLandCO2Flux_Emon_AWI-ESM-1-1-LR_historical_r1i1p1f1_gn_185101-185112.nc";
...
"netAtmosLandCO2Flux_Emon_EC-Earth3-CC_historical_r1i1p1f1_gr_185101-185112.nc";
...
legend
saveas(gcf, 'land_CO2_flux_line1851.png')
...
saveas(gcf, 'land_CO2_flux_Bar1851.png')

save output_land_plot1851.mat CO2_flux_land_year_areas CO2_flux_land_year_LON lat_land model
...
function [time_land,lat_land,lon_land,CO2_land,model] = select_parameter(filepath,filename)
    ...
    is_1851=time_land>365&time_land<=365+365;
    time_land = time_land(is_1851);
    lat_land = land.lat.data;
    lon_land = land.lon.data;
    CO2_land = -land.netAtmosLandCO2Flux.data(is_1851,:,:);
