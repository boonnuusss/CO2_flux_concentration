...
land_filename = [...
"netAtmosLandCO2Flux_Emon_AWI-ESM-1-1-LR_historical_r1i1p1f1_gn_190001-190012.nc";
...
"netAtmosLandCO2Flux_Emon_EC-Earth3-CC_historical_r11i1p1f1_gr_190001-190012.nc";
...
for i = 1:length(land_filename)
    ...
    hold on
    title("land CO2 flux in 1900")
    xlabel('Latitude')
    ylabel('CO2 flux (PgC yr^-^1)')
    
end
legend
saveas(gcf, 'land_CO2_flux_line1900.png')
...
saveas(gcf, 'land_CO2_flux_Bar1900.png')

save output_land_plot1900.mat CO2_flux_land_year_areas CO2_flux_land_year_LON lat_land model
...
function [time_land,lat_land,lon_land,CO2_land,model] = select_parameter(filepath,filename)
    ...
    if filename == "netAtmosLandCO2Flux_Emon_AWI-ESM-1-1-LR_historical_r1i1p1f1_gn_190001-190012.nc"...
            || filename=="netAtmosLandCO2Flux_Emon_CESM2_historical_r11i1p1f1_gn_190001-194912.nc"...
            || filename=="netAtmosLandCO2Flux_Emon_EC-Earth3-CC_historical_r11i1p1f1_gr_190001-190012.nc"...
        ...
        % if filename == "netAtmosLandCO2Flux_Emon_CESM2_historical_r11i1p1f1_gn_190001-194912.nc"
        %     time0 = datenum('1850-01-01 00:00:00', 'yyyy-mm-dd HH:MM:SS')-datenum('0001-01-01 00:00:00', 'yyyy-mm-dd HH:MM:SS');
        %     time_land = land.time.data+datenum('0001-01-01 00:00:00', 'yyyy-mm-dd HH:MM:SS');
        %     time_land_datetime = datetime(time_land, 'ConvertFrom', 'datenum');
        %     keyboard
        % end
    else
    ...
    if filename== "netAtmosLandCO2Flux_Emon_AWI-ESM-1-1-LR_historical_r1i1p1f1_gn_190001-190012.nc"...
            || filename== "netAtmosLandCO2Flux_Emon_CESM2_historical_r11i1p1f1_gn_190001-194912.nc"...
            || filename== "netAtmosLandCO2Flux_Emon_EC-Earth3-CC_historical_r11i1p1f1_gr_190001-190012.nc"
        is_1900=(time_land<365);
    elseif filename== "netAtmosLandCO2Flux_Emon_MPI-ESM-1-2-HAM_historical_r1i1p1f1_gn_189001-190912.nc"
            is_1900=(3653<=time_land)&(time_land<=4017);
    else
        is_1900=(18263<=time_land)&(time_land<=18627);
    end

    time_land = time_land(is_1900);
    lat_land = land.lat.data;
    lon_land = land.lon.data;
    CO2_land = -land.netAtmosLandCO2Flux.data(is_1900,:,:);
