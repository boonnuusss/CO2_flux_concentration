...
land_filename = [...
"netAtmosLandCO2Flux_Emon_AWI-ESM-1-1-LR_historical_r1i1p1f1_gn_195501-195512.nc";
...
"netAtmosLandCO2Flux_Emon_EC-Earth3-CC_historical_r1i1p1f1_gr_195501-195512.nc";
...
for i = 1:length(land_filename)
    ...
    hold on
    title("land CO2 flux in 1955")
    xlabel('Latitude')
    ylabel('CO2 flux (PgC yr^-^1)')
    
end
legend
saveas(gcf, 'land_CO2_flux_line1955.png')
...
saveas(gcf, 'land_CO2_flux_Bar1955.png')

save output_land_plot1955.mat CO2_flux_land_year_areas CO2_flux_land_year_LON lat_land model
...
function [time_land,lat_land,lon_land,CO2_land,model] = select_parameter(filepath,filename)
    ...
    if filename== "netAtmosLandCO2Flux_Emon_AWI-ESM-1-1-LR_historical_r1i1p1f1_gn_195501-195512.nc"...
            || filename== "netAtmosLandCO2Flux_Emon_CESM2_historical_r11i1p1f1_gn_195001-199912.nc"...
            || filename=="netAtmosLandCO2Flux_Emon_EC-Earth3-CC_historical_r11i1p1f1_gr_195501-195512.nc"...
    ...
    if filename== "netAtmosLandCO2Flux_Emon_AWI-ESM-1-1-LR_historical_r1i1p1f1_gn_195501-195512.nc"...
            || filename== "netAtmosLandCO2Flux_Emon_EC-Earth3-CC_historical_r11i1p1f1_gr_195501-195512.nc"
        startYear=1955;
        is_1955 = cal_target_year_index(startYear,targetYear,time_land);
    ...
    time_land = time_land(is_1955);
    lat_land = land.lat.data;
    lon_land = land.lon.data;
    CO2_land = -land.netAtmosLandCO2Flux.data(is_1955,:,:);
