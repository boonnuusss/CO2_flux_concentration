...
land_filename = [...
"netAtmosLandCO2Flux_Emon_AWI-ESM-1-1-LR_historical_r1i1p1f1_gn_195601-195612.nc";
"netAtmosLandCO2Flux_Emon_CanESM5_historical_r5i1p1f1_gn_185001-201412.nc";
"netAtmosLandCO2Flux_Emon_CESM2_historical_r11i1p1f1_gn_195001-199912.nc";
...
"netAtmosLandCO2Flux_Emon_EC-Earth3-CC_historical_r11i1p1f1_gr_195601-195612.nc";
...
"netAtmosLandCO2Flux_Emon_MPI-ESM-1-2-HAM_historical_r1i1p1f1_gn_195001-196912.nc";
...
for i = 1:length(land_filename)
    ...
    hold on
    title("land CO2 flux in 1956")
    xlabel('Latitude')
    ylabel('CO2 flux (PgC yr^-^1)')
    
end
legend
saveas(gcf, 'land_CO2_flux_line1956.png')
...
saveas(gcf, 'land_CO2_flux_Bar1956.png')

save output_land_plot1956.mat CO2_flux_land_year_areas CO2_flux_land_year_LON lat_land model
...
function [time_land,lat_land,lon_land,CO2_land,model] = select_parameter(filepath,filename)
    ...
    if filename== "netAtmosLandCO2Flux_Emon_AWI-ESM-1-1-LR_historical_r1i1p1f1_gn_195601-195612.nc"...
            || filename== "netAtmosLandCO2Flux_Emon_CESM2_historical_r11i1p1f1_gn_195001-199912.nc"...
            || filename=="netAtmosLandCO2Flux_Emon_EC-Earth3-CC_historical_r11i1p1f1_gr_195601-195612.nc"...
            || filename== "netAtmosLandCO2Flux_Emon_MPI-ESM-1-2-HAM_historical_r1i1p1f1_gn_195001-196912.nc"...
    ...
    if filename== "netAtmosLandCO2Flux_Emon_AWI-ESM-1-1-LR_historical_r1i1p1f1_gn_195601-195612.nc"...
            || filename== "netAtmosLandCO2Flux_Emon_EC-Earth3-CC_historical_r11i1p1f1_gr_195601-195612.nc"
        startYear=1956;
        is_1956 = cal_target_year_index(startYear,targetYear,time_land);
    elseif filename== "netAtmosLandCO2Flux_Emon_CESM2_historical_r11i1p1f1_gn_195001-199912.nc"...
            || filename == "netAtmosLandCO2Flux_Emon_GFDL-ESM4_historical_r1i1p1f1_gr1_195001-201412.nc"...
            || filename == "netAtmosLandCO2Flux_Emon_MPI-ESM-1-2-HAM_historical_r1i1p1f1_gn_195001-196912.nc"...
            || filename == "netAtmosLandCO2Flux_Emon_UKESM1-0-LL_historical_r1i1p1f2_gn_195001-201412.nc"
        startYear=1950;
    ...
    time_land = time_land(is_1956);
    lat_land = land.lat.data;
    lon_land = land.lon.data;
    CO2_land = -land.netAtmosLandCO2Flux.data(is_1956,:,:);
