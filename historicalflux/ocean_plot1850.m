...
"fgco2_Omon_EC-Earth3-CC_historical_r1i1p1f1_gn_185001-185012.nc";
"fgco2_Omon_GFDL-ESM4_historical_r1i1p1f1_gr_185001-186912.nc";
"fgco2_Omon_MIROC-ES2H_historical_r1i1p4f2_gn_185001-201412.nc";
"fgco2_Omon_MPI-ESM-1-2-HAM_historical_r1i1p1f1_gn_185001-186912.nc"
...
add_data = [0.083;-0.22;1.36;-0.71;-0.52];
...
for i = 1:length(ocean_filename)
    ...
    hold on
    title("ocean CO2 flux in 1850")
    xlabel('Latitude')
    ylabel('CO2 flux (PgC yr^-^1)')
    
end
legend
saveas(gcf, 'ocean_CO2_flux_line1850.png')
...
saveas(gcf, 'ocean_CO2_flux_Bar1850.png')
...
function [time_ocean,lat_ocean,lon_ocean,CO2_ocean,model] = select_parameter(filepath,filename)
    ...
    elseif filename=="fgco2_Omon_GFDL-ESM4_historical_r1i1p1f1_gr_185001-186912.nc"
    ...
    is_1850=time_ocean<=365;
    time_ocean = time_ocean(is_1850);
    CO2_ocean = -ocean.fgco2.data(is_1850,:,:);
...
function [lat_ocean,CO2_flux_ocean_year_LON,model,CO2_flux_ocean_year_areas]=plot_CO2_flux_ocean_year(filepath,ocean_filename, ocean_areacello_filename)
    ...
    if ocean_filename=="fgco2_Omon_MPI-ESM-1-2-HAM_historical_r1i1p1f1_gn_185001-186912.nc"
