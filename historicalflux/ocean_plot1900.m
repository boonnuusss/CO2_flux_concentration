...
"fgco2_Omon_EC-Earth3-CC_historical_r1i1p1f1_gn_190001-190012.nc";
"fgco2_Omon_GFDL-ESM4_historical_r1i1p1f1_gr_189001-190912.nc";
"fgco2_Omon_MIROC-ES2H_historical_r1i1p4f2_gn_185001-201412.nc";
"fgco2_Omon_MPI-ESM-1-2-HAM_historical_r1i1p1f1_gn_189001-190912.nc"
...
function [time_ocean,lat_ocean,lon_ocean,CO2_ocean,model] = select_parameter(filepath,filename)
    ...
    elseif filename=="fgco2_Omon_GFDL-ESM4_historical_r1i1p1f1_gr_189001-190912.nc"
    ...
    if filename == "fgco2_Omon_CESM2_historical_r1i1p1f1_gn_185001-201412.nc"...
            || filename=="fgco2_Omon_EC-Earth3-CC_historical_r1i1p1f1_gn_190001-190012.nc"...
            || filename== "fgco2_Omon_MPI-ESM-1-2-HAM_historical_r1i1p1f1_gn_189001-190912.nc"...
            || filename== "fgco2_Omon_GFDL-ESM4_historical_r1i1p1f1_gr_189001-190912.nc"
        time_ocean = ocean.time.data-ocean.time.data(1);
    else
        time_ocean = ocean.time.data;
    end

    if filename== "fgco2_Omon_EC-Earth3-CC_historical_r1i1p1f1_gn_190001-190012.nc"
        is_1900=(time_ocean<365);
    elseif filename== "fgco2_Omon_GFDL-ESM4_historical_r1i1p1f1_gr_189001-190912.nc"...
            || filename== "fgco2_Omon_MPI-ESM-1-2-HAM_historical_r1i1p1f1_gn_189001-190912.nc"
...
function [lat_ocean,CO2_flux_ocean_year_LON,model,CO2_flux_ocean_year_areas]=plot_CO2_flux_ocean_year(filepath,ocean_filename, ocean_areacello_filename)
    ...
    if ocean_filename=="fgco2_Omon_MPI-ESM-1-2-HAM_historical_r1i1p1f1_gn_189001-190912.nc"
